    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区医疗服务可视化系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="编号" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuUuidNumber" autocomplete="off" placeholder="编号"  />
                           </el-form-item>
                        -->
                        ...
                        <!--
                            <el-form-item label="住址" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuAddress" autocomplete="off" placeholder="住址"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yonghu 中的 住址 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuAddress== null ||this.ruleForm.yonghuAddress== "")){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/shequyilliaofuwu/img/back-img-bg.jpg);
