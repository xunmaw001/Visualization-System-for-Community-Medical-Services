    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="编号" prop="yonghuUuidNumber">
                       <el-input v-model="ruleForm.yonghuUuidNumber"
                                 placeholder="编号" clearable  :readonly="ro.yonghuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="编号" prop="yonghuUuidNumber">
                           <el-input v-model="ruleForm.yonghuUuidNumber"
